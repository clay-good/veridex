...
| **Video/media checks** | Read an `.mp4` or `.mkv`/`.webm` container's headers — never a pixel — and catch the missing, unparseable, desynced, or re-encoded video behind a camera stream |
