...
| `statistical.value-measurability` | the adapter never read values (MCAP, rosbag2, RLDS), or read them but had no stored statistics to compare against (HDF5, Zarr, CAN+DBC, MF4) |
